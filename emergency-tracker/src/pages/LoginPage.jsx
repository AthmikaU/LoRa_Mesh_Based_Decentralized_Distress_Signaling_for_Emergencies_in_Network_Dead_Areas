...
//       if (isNaN(nodeNum)) {
//         setError("⚠️ Node ID must be a number");
//       } else if (nodeNum < minNode || nodeNum > maxNode) {
//         setError(`⚠️ Node ID must be between ${minNode} and ${maxNode}`);
//       } else {
//         localStorage.setItem("token", `node-${nodeNum}`);
//         localStorage.setItem("role", "user");
//         localStorage.setItem("nodeID", nodeNum);
//         setToken(`node-${nodeNum}`);
//         navigate(`/userdashboard/${nodeNum}`); // ✅ Correct path for user
//       }
//     } else {
...
//               <input
//                 type="text"
//                 placeholder="Enter Node ID (1–50)"
//                 value={nodeID}
